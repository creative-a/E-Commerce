...
class Test_OTGS_Template_Service_Php_Model extends OTGS_TestCase {
	...
	public function it_builds_a_model_of_primitives_attributes() {
		...
		$model = new OTGS_Template_Service_Php_Model( $data );
	...
	public function it_builds_a_model_of_complex_attributes() {
		...
		$this->assertInstanceOf(OTGS_Template_Service_Php_Model::class, $model->complex);
		$this->assertSame( $data['complex']['a'], $model->complex->a );
		$this->assertSame( $data['complex']['b'], $model->complex->b );

		$this->assertInstanceOf(OTGS_Template_Service_Php_Model::class, $model->complex->c);
		$this->assertSame( $data['complex']['c']['ca'], $model->complex->c->ca );
		$this->assertSame( $data['complex']['c']['cb'], $model->complex->c->cb );
	}
}
